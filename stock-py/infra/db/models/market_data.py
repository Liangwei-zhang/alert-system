...
class OhlcvModel(Base):
    ...
    open: Mapped[float] = mapped_column(Numeric(15, 6))
    high: Mapped[float] = mapped_column(Numeric(15, 6))
    low: Mapped[float] = mapped_column(Numeric(15, 6))
    close: Mapped[float] = mapped_column(Numeric(15, 6))
